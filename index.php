...
<body>
  <ul>
    <?php foreach($privacyTerms as $privacyParagraph):?>
      <li><?php echo $privacyParagraph["title"].$privacyParagraph["paragraph"] ?></li>
    <?php endforeach; ?>
  </ul>
</body>
</html>